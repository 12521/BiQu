...
%\usetheme{default}
%\usetheme{AnnArbor}%黄紫
%\usetheme{Antibes}%紫 上侧目录
%\usetheme{Bergen}%紫，左侧目录
%\usetheme{Berkeley}
%\usetheme{Berlin}
%\usetheme{Boadilla}
...
\title[Short Title]{中期报告} % The short title in the optional parameter appears at the bottom of every slide, the full title in the main parameter is only on the title page
